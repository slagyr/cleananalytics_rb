require 'cleananalytics/charts'
require 'cleananalytics/data'
require 'cleananalytics/curl'
require 'cleananalytics/models'
...
module Cleantracker
  ...
  class Director
    ...
    CHARTS = {
            ...
            :revenue_per_month => BAR.merge(:before => :_license_abbrs, :model => :licenses, :title => "$ Revenue/Month", :valuator => LICENSE_REV, :split => :level, :chart_kind => :stacked_bar),
